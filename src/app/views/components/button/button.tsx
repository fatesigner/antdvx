            ...
            <div class='tw-grid tw-gap-4 lg:tw-grid-cols-2'>
              {ANTDVX_BUTTON_TYPES.map((type) => (
                <div class='tw-border tw-border-gray-300 tw-p-2'>
                  <div class='tw-p-2 tw-text-lg'>{type} button</div>
                  <div class='tw-p-2 tw-text-sm'>Colors</div>
                  ...
                  <div class='tw-p-2 tw-text-sm'>Sizes</div>
                  <div class='tw-flex tw-flex-wrap'>
                  ...
                  <div class='tw-p-2 tw-text-sm'>Href Link</div>
                  <div class='tw-flex tw-flex-wrap'>
                    <div class='tw-p-2'>
                  ...
                  <div class='tw-p-2 tw-text-sm'>Dropdown</div>
                  <div class='tw-p-2'>
                    <Dropdown
                      v-slots={{
                        overlay() {
              ...
              <div class='tw-border tw-border-gray-300 tw-p-2'>
                <div class='tw-p-2 tw-text-lg'>功能性</div>
                <div class='tw-p-2 tw-text-sm tw-text-gray-600'>基于 Button 封装的常用的一些操作按钮。</div>
                <div class='tw-p-2 tw-text-xxs tw-text-gray-500'>
                  用于需要异步操作的按钮，提供一个异步函数 handler，函数执行阶段，将自动添加
                  loading，结束后，若该函数抛出异常，则自动显示 notification。
                </div>
