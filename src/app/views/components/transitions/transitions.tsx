...
import { Alert, Radio, RadioGroup, Spin, TabPane, Tabs } from 'ant-design-vue';
import {
  ANTDVX_DIRECTIONS,
  ANTDVX_SIZES,
  TransitionCollapse,
  ...
  render(ctx) {
    return (
      <PageWrapper title='Transitions' overflow='scroll'>
        <div class='tw-p-2'>
          <div class='tw-grid tw-gap-4 tw-bg-white tw-p-4 lg:tw-grid-cols-2'>
            ...
            <div class='tw-space-y-4 tw-border tw-border-gray-300 tw-p-4'>
              ...
              <div class='tw-relative tw-h-64 tw-overflow-auto'>
                <TransitionZoom>
                  {ctx.zoom ? (
                    <div class='tw-absolute tw-top-4 tw-left-1/2 tw--translate-x-1/2 tw-transform'>
                      <Alert
                        type='error'
                        v-slots={{
                          description() {
